...
const BN = {
  ...
  "inactive": "নিষ্ক্রিয়",
  "Today collected": "আজকের আদায়",
  "All dues till today": "আজ পর্যন্ত মোট বকেয়া",
  "Agenda:": "এজেন্ডা:",
  "Decisions:": "সিদ্ধান্ত:",
  "Owners": "মালিকবৃন্দ",
  ...
  "one per line — Name, Relation": "প্রতি লাইনে — নাম, সম্পর্ক",
  "one line: Label, Value": "প্রতি লাইনে: লেবেল, মান",
  "💾 Save changes": "💾 পরিবর্তন সংরক্ষণ",
  "Business & occupation": "ব্যবসা ও পেশা",
  "Address": "ঠিকানা",
  "e.g. Rahman Mobile Gallery": "যেমন: রহমান মোবাইল গ্যালারি",
  "e.g. Business / Service": "যেমন: ব্যবসা / চাকরি",
  ...
  "Payer (owner)": "প্রদানকারী (মালিক)",
  "Bill amount": "বিলের পরিমাণ",
  "Late fee": "দেরি ফি",
  "Includes late fee of": "দেরি ফি অন্তর্ভুক্ত",
  "bill overdue": "বিল মেয়াদোত্তীর্ণ",
  "💾 Save & print receipt": "💾 সংরক্ষণ ও রসিদ প্রিন্ট",
  "Full": "সম্পূর্ণ",
  "No payments recorded for this space yet.": "এই দোকানের জন্য এখনো কোনো পেমেন্ট নেই।",
  "Save & print receipt": "সংরক্ষণ ও রসিদ প্রিন্ট",
  "Today collected": "আজকের আদায়",
  "receipts today": "টি রসিদ আজ",
  "All dues till today": "আজ পর্যন্ত মোট বকেয়া",/* ── Mall buttons & forms (sweep) ── */
  "Cancel": "বাতিল",
  "Close": "বন্ধ করুন",
  "Search": "সার্চ",
