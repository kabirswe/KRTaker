...
const routes = [
  ...
  { path: '/compliance', name: 'compliance', component: () => import('../views/CollectionView.vue'), props: { collection: 'compliance_items' } },
  { path: '/legal', name: 'legal', component: () => import('../views/LegalView.vue') },
  { path: '/utility-bills', name: 'utility-bills', component: () => import('../views/CollectionView.vue'), props: { collection: 'utility_bills' } },
  { path: '/meter-readings', name: 'meter-readings', component: () => import('../views/CollectionView.vue'), props: { collection: 'meter_readings' } },
  ...
  { path: '/documents', name: 'documents', component: () => import('../views/CollectionView.vue'), props: { collection: 'documents' } },
