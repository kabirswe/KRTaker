...
const routes = [
  ...
  { path: '/partner-invoices', name: 'partner-invoices', component: () => import('../views/PartnerInvoicesView.vue') },
  { path: '/vendor-payouts', name: 'vendor-payouts', component: () => import('../views/VendorPayoutsView.vue') },
